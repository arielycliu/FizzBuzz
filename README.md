...
1. Program is inside of a class
2. For loop works more like setting and incrementing a variable
3. Strongly typed - have to indicate it's a boolean type
4. Else if instead of "elif", curly braces instead of colon + indentation to identify loops
5. System.out.println instead of print
